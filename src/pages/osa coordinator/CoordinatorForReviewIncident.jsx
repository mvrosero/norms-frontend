...
export default function CoordinatorForReviewIncident() {
    return (
        <div>
            ...
            <div style={{ textAlign: 'right', marginTop: '5px', marginBottom: '30px', marginRight: '60px' }}>
                <button type="button" style={{ padding: '8px 40px', fontSize: '20px', backgroundColor: '#C90505', color: 'white', border: 'none', borderRadius: '10px', cursor: 'pointer', marginRight: '5px', fontWeight: '600', width: '150px' }}>Decline</button>
                <button type="submit" style={{ padding: '8px 40px', fontSize: '20px', backgroundColor: '#30A702', color: 'white', border: 'none', borderRadius: '10px', cursor: 'pointer', fontWeight: '600' }}>Approve</button>
            </div>
        </div>
    );
}
