                ...
                <Modal.Body>
                    ...
                    <div style={timelineStyle}>
                            ...
                            <div style={{ marginLeft: '80px', display: 'flex', gap: '10px' }}>
                                <button 
                                    ...
                                    onClick={() => {
                                        ...
                                        link.href = 'files/students_infotemplate.csv'; 
                                        link.download = 'students_infotemplate.csv';   
                                        link.click();  
                                    }}>
                                ...
                                <button 
                                    ...
                                    onClick={() => {
                                        const link = document.createElement('a');
                                        link.href = 'files/students_blanktemplate.csv'; 
                                        link.download = 'students_blanktemplate.csv';   
                                        link.click();  
                                    }}>
                                    <BiSolidDownload style={{ marginRight: '8px', fontSize: '15px' }} />
                        ...
                        <div style={timelineItemStyle}>
                            ...
                            <div style={{ fontSize: '14px', marginLeft: '80px', marginTop: '0px' }}>Required fields are student id number, full name, email, password, department, and program.</div>
